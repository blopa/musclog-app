...
[`patches/expo-router+57.0.13.patch`](/patches/expo-router+57.0.13.patch) — see below. Expo Router 57
...
Expo Router 57.0.13 still labels data loaders as alpha.
[`patches/expo-router+57.0.13.patch`](/patches/expo-router+57.0.13.patch) carries three fixes, all
