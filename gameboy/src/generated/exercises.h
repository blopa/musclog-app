...
typedef enum {
    ...
    EX_MUSCLE_BACK = 2,
    EX_MUSCLE_CHEST = 3,
    EX_MUSCLE_FULL_BODY = 4,
    EX_MUSCLE_GLUTES = 5,
    EX_MUSCLE_LEGS = 6,
    EX_MUSCLE_SHOULDERS = 7,
} exercise_muscle_group_t;

#define EXERCISE_MUSCLE_GROUP_COUNT 8u

typedef enum {
    EX_EQUIPMENT_BARBELL = 0,
    EX_EQUIPMENT_BODYWEIGHT = 1,
    EX_EQUIPMENT_CABLE = 2,
    EX_EQUIPMENT_DUMBBELL = 3,
    EX_EQUIPMENT_KETTLEBELL = 4,
    EX_EQUIPMENT_OTHER = 5,
    EX_EQUIPMENT_PLATE_MACHINE = 6,
    EX_EQUIPMENT_SMITH_MACHINE = 7,
} exercise_equipment_type_t;

#define EXERCISE_EQUIPMENT_TYPE_COUNT 8u

typedef enum {
    EX_MECHANIC_COMPOUND = 0,
    EX_MECHANIC_ISOLATION = 1,
    EX_MECHANIC_PLYOMETRIC = 2,
