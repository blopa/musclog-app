 ...
 *  0x06  |   1   | SRAM_FLAGS2         | [5]=rtc_is_set [4]=onboarding [3:2]=weight_goal
 * [1:0]=fitness 0x07  |   1   | SRAM_AGE            | Age in years (13-99) 0x08  |   1   |
 * SRAM_HEIGHT         | height_cm - DB_HEIGHT_CM_MIN (0-110) 0x09  |   2   | SRAM_WEIGHT         |
 * weight_kg_tenths - DB_WEIGHT_KG_TENTHS_MIN (lo, hi) 0x0B  |   2   | SRAM_CAL_GOAL       | Calorie
 * goal kcal (lo, hi) 0x0D  |   2   | SRAM_PROTEIN_GOAL   | Protein goal g (lo, hi) 0x0F  |   2   |
 * SRAM_CARBS_GOAL     | Carbs goal g (lo, hi) 0x11  |   2   | SRAM_FAT_GOAL       | Fat goal g (lo,
 * hi) 0x13  |   1   | SRAM_FIBER_GOAL     | Fiber goal g (0-99) 0x14  |   1   | SRAM_RTC_YEAR_OFS
 * | rtc_base_date.year - 2000 (0-99) 0x15  |   1   | SRAM_RTC_MONTH      | rtc_base_date.month
 * (1-12) 0x16  |   1   | SRAM_RTC_DAY        | rtc_base_date.day (1-31)
 *  ------|-------|---------------------|------------------------------------------- (checksummed:
 * 23 bytes) 0x17  |   1   | SRAM_RTC_HOUR       | seed hint: hour   (0-23) — NOT checksummed 0x18
 * |   1   | SRAM_RTC_MINUTE     | seed hint: minute (0-59) — NOT checksummed
 *  ------|-------|---------------------|-------------------------------------------
...
#define SRAM_SAVE_SIZE                                                                             \
    SRAM_LAYOUT_PROFILE_SAVE_SIZE /* 23 bytes — size of the checksummed profile block */
