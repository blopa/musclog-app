  ...
  tables: [
    ...
    tableSchema({
      ...
      columns: [
        ...
        // { name: 'external_id', type: 'string', isIndexed: true }, // TODO: uncomment this - it will be use to store the ID of external data integration, like Health Connect, and used to sync data - and then update the services and models
