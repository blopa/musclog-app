...
export class FoodPortionService {
   ...
   */
  private static getCommonPortionsForFoodType(foodName: string, servingUnit: string): Array<{ name: string; gramWeight: number }> {
    const name = foodName.toLowerCase();
    const portions: Array<{ name: string; gramWeight: number }> = [];
