...
export default function PersonalizedPreferencesScreen() {
  ...
  const handleContinue = async () => {
    ...
    try {
      ...
      await AsyncStorage.setItem(
        ...
        JSON.stringify({ ...current, fullName: fullName.trim(), gender, units })
      );
        ...
        >
          <View className="px-6 pt-6">
            ...
            <View className="mb-8 gap-3">
              ...
              >
                {t('onboarding.personalizedPreferences.nameLabel')}
              </Text>
              <TextInput
                label=""
                value={fullName}
                onChangeText={setFullName}
                placeholder={t('onboarding.personalizedPreferences.namePlaceholder')}
                icon={<User size={16} color={theme.colors.text.tertiary} />}
              />
            </View>
