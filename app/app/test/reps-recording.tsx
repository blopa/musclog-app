...
export default function RepsRecordingScreen() {
    ...
    const handleSave = useCallback(async () => {
        ...
        if (!videoUri || !fullExercise || !wit.connectedDevice) {return;}
        setIsSaving(true);
        try {
    ...
    }, [repsInput, storagePermissionGranted, videoUri, fullExercise, wit.connectedDevice, selectedExercise]);
    ...
    return (
        <MasterLayout>
            <ScrollView contentContainerStyle={{ padding: 16, gap: 12 }}>
                ...
                {!storagePermissionGranted ? <View style={{ backgroundColor: '#7a5c00', borderRadius: 10, padding: 12, gap: 8 }}>
                ...
                <View style={{ backgroundColor: '#111', borderRadius: 12, padding: 14, gap: 10 }}>
                    ...
                    {/* Discovered devices */}
                    {wit.discoveredDevices.length > 0 ? <View style={{ gap: 4 }}>
                    ...
                    {wit.connectedDevice ? <Text style={{ color: '#aaa', fontSize: 11 }}>
                ...
                <View style={{ backgroundColor: '#111', borderRadius: 12, padding: 14, gap: 10 }}>
                    ...
                    {!wit.isConnected ? <Text style={{ color: '#888', fontSize: 11 }}>Connect a BLE device to enable recording</Text> : null}
                    {!selectedExercise && wit.isConnected ? <Text style={{ color: '#888', fontSize: 11 }}>Select an exercise to enable recording</Text> : null}
                </View>
                ...
                <View style={{ backgroundColor: '#111', borderRadius: 12, padding: 14, gap: 10 }}>
                    ...
                    {isRecording ? <View style={{ flexDirection: 'row', gap: 16, alignItems: 'center' }}>
