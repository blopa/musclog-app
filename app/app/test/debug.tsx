...
const APP_SCREENS = [
  { name: 'Home', route: '/app/', category: 'Main' },
  { name: 'Profile', route: '/app/profile', category: 'Main' },
  { name: 'Food', route: '/app/nutrition/food', category: 'Nutrition' },
  {
    name: 'Nutrition Check-in List',
    route: '/app/nutrition/checkin-list',
    category: 'Nutrition',
  },
  { name: 'Workouts', route: '/app/workout/workouts', category: 'Workout' },
  { name: 'Workout Session', route: '/app/workout/workout-session', category: 'Workout' },
  { name: 'Workout Summary', route: '/app/workout/workout-summary', category: 'Workout' },
  { name: 'Rest Timer', route: '/app/workout/rest-timer', category: 'Workout' },
  { name: 'Rest Over', route: '/app/workout/rest-over', category: 'Workout' },
  { name: 'Landing', route: '/app/onboarding/landing', category: 'Onboarding' },
  { name: 'Personalized: Preferences', route: '/app/onboarding/personalized-preferences', category: 'Onboarding' },
  { name: 'Personalized: Experience', route: '/app/onboarding/personalized-experience', category: 'Onboarding' },
  { name: 'Personalized: Goals', route: '/app/onboarding/personalized-goals', category: 'Onboarding' },
  { name: 'Personalized: Body Stats', route: '/app/onboarding/personalized-body-stats', category: 'Onboarding' },
  { name: 'Personalized: Cycle', route: '/app/onboarding/personalized-cycle', category: 'Onboarding' },
  { name: 'Quick: Preferences', route: '/app/onboarding/quick-preferences', category: 'Onboarding' },
  { name: 'Quick: Goals', route: '/app/onboarding/quick-goals', category: 'Onboarding' },
  { name: 'Quick: Body Stats', route: '/app/onboarding/quick-body-stats', category: 'Onboarding' },
  { name: 'Nutrition Goals', route: '/app/onboarding/nutrition-goals', category: 'Onboarding' },
  {
    name: 'Nutrition Goals Results',
    route: '/app/onboarding/nutrition-goals-results',
    category: 'Onboarding',
  },
  { name: 'Cycle Setup', route: '/app/onboarding/cycle-setup', category: 'Onboarding' },
  { name: 'Health Connect', route: '/app/onboarding/health-connect', category: 'Onboarding' },
  { name: 'Test: Buttons', route: '/app/test/buttons', category: 'Test' },
  { name: 'Test: Cards', route: '/app/test/cards', category: 'Test' },
  { name: 'Test: Empty States', route: '/app/test/empty-states', category: 'Test' },
  { name: 'Test: Inputs', route: '/app/test/inputs', category: 'Test' },
  { name: 'Test: Modals', route: '/app/test/modals', category: 'Test' },
