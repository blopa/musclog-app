...
const APP_SCREENS = [
  ...
  { name: 'Onboarding', route: '/app/onboarding/onboarding', category: 'Onboarding' },
  { name: 'Personal Info', route: '/app/onboarding/personal-info', category: 'Onboarding' },
  { name: 'Fitness Info', route: '/app/onboarding/fitness-info', category: 'Onboarding' },
  { name: 'Set Goals', route: '/app/onboarding/set-goals', category: 'Onboarding' },
