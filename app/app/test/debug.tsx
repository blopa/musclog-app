...
const APP_SCREENS = [
  ...
  { name: 'Landing', route: '/app/onboarding/landing', category: 'Onboarding' },
  {
    ...
    route: '/app/onboarding/personalized-preferences',
    category: 'Onboarding',
  },
  {
    name: 'Personalized: Experience',
    route: '/app/onboarding/personalized-experience',
    category: 'Onboarding',
  },
  {
    name: 'Personalized: Goals',
    route: '/app/onboarding/personalized-goals',
    category: 'Onboarding',
  },
  {
    name: 'Personalized: Body Stats',
    route: '/app/onboarding/personalized-body-stats',
    category: 'Onboarding',
  },
  {
    name: 'Personalized: Cycle',
    route: '/app/onboarding/personalized-cycle',
    category: 'Onboarding',
  },
  {
    name: 'Quick: Preferences',
    route: '/app/onboarding/quick-preferences',
    category: 'Onboarding',
  },
  ...
  { name: 'Test: Nutrition Debug', route: '/app/test/nutrition-debug', category: 'Test' },
  { name: 'Test: Optical Transfer', route: '/app/test/optical-bench', category: 'Test' },
];
