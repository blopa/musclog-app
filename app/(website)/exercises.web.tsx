...
const EXERCISE_IMAGE = (index: number) =>
    withExpoBaseUrl(`/images/exercises/exercise${index}.png`);
            ...
            <main>
                ...
                <section className="relative overflow-hidden pb-12 pt-24 md:pb-16 md:pt-32">
                    ...
                    <div className="container relative z-10 mx-auto px-4 text-center">
                        ...
                        <p
                            className="mx-auto max-w-xl text-balance text-lg"
                            style={{ color: BODY_TEXT }}
                        >
                            {t('pageDescription')}
                        </p>
                                ...
                                {filtered.map((exercise) => {
                                    ...
                                    return (
                                        <ExerciseCard
                                            ...
                                            targetMuscleLabels={getTargetMuscleLabels(
                                                ex.targetMuscles
                                            )}
                                        />
                                    );
