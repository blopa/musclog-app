...
![Musclog workout logging screen, where the reps actually get entered](/images/blog/2026/07/musclog-workout-logging.webp)
...
![It's all AI](/images/blog/2026/07/ai-ai-ai-ai.webp)
...
![Pushup set analyzed: 10 reps detected, avg 1.43s per rep, Phase A vs Phase B breakdown per rep](/images/blog/2026/07/pushups-insights.webp)
...
![The v0-built overlay editor: drag sliders until the red outline matches the device photo, then download the STL](/images/blog/2026/07/v0-sketch-to-stl.webp)
...
![The case (blue) and the device model (tan) in Tinkercad](/images/blog/2026/07/tinkercad-modeling.webp)

![Same device next to a barbell model for scale](/images/blog/2026/07/tinkercad-modeling-barbell.webp)
