...
const SECTIONS: Section[] = [
  {
    ...
    rows: [
      ...
      { id: 'openSource', cells: [[F, 'gpl3'], N, N, N, N, N, N, N, N] },
      { id: 'noProprietaryAccount', cells: [F, N, N, N, N, [P, 'appleEcosystem'], N, N, N] },
      { id: 'localFirst', cells: [F, N, N, N, N, [P, 'appleHealthCentric'], N, N, N] },
      {
        id: 'fullyOffline',
        cells: [
          F,
      ...
      {
        id: 'localEncryption',
        cells: [F, N, N, N, N, [P, 'applePlatform'], [P, 'serverEncryption'], N, N],
      },
      { id: 'rawDbAccess', cells: [F, N, N, N, N, N, N, N, N] },
      { id: 'migrationBackups', cells: [F, N, N, N, N, N, N, N, N] },
      {
        id: 'completeBackup',
        cells: [
          [F, 'jsonDbExcel'],
      ...
      { id: 'adsInFree', inverse: true, cells: [N, F, F, N, N, N, F, P, N] },
    ],
  },
  {
    id: 'nutrition',
    ...
    rows: [
      ...
      {
        id: 'micronutrients',
        cells: [[F, 'micros40'], P, P, F, N, P, [F, 'upTo84'], P, N],
      },
      { id: 'barcode', cells: [F, [P, 'paid'], F, F, N, F, F, F, N] },
      { id: 'customFoods', cells: [F, F, F, F, N, F, F, F, N] },
      { id: 'savedMeals', cells: [F, F, F, F, N, F, F, F, N] },
      {
        id: 'aiPhoto',
        cells: [F, [P, 'paid'], [P, 'premium'], F, N, F, [P, 'gold'], [P, 'premium'], N],
      },
      {
        id: 'naturalLanguage',
        cells: [F, [P, 'paidVoice'], N, F, N, F, [P, 'goldVoice'], [P, 'premium'], N],
      },
      { id: 'labelOcr', cells: [F, P, N, F, N, P, P, P, N] },
      {
        id: 'foodDbSelection',
        cells: [F, N, N, [P, 'curatedSources'], N, N, [P, 'verifiedDatabases'], N, N],
      },
      { id: 'netCarbs', cells: [F, [P, 'paid'], P, F, N, P, F, P, N] },
      { id: 'empiricalTdee', cells: [F, N, N, F, N, N, N, N, N] },
      { id: 'autoTarget', cells: [F, P, N, F, N, [P, 'aiGuidance'], P, P, N] },
      {
        id: 'weeklyCheckins',
        cells: [F, P, P, F, N, [F, 'ai'], P, [F, 'nutritionAdvice'], N],
      },
      { id: 'intuitiveEating', cells: [F, N, N, N, N, N, N, N, N] },
      {
        id: 'fastedDays',
        cells: [F, [P, 'fastingFeature'], N, P, N, P, [P, 'timer'], [P, 'plansTimer'], N],
      },
      {
        id: 'supplements',
        cells: [F, P, N, [P, 'logging'], N, [P, 'journal'], [F, 'logging'], P, N],
      },
      { id: 'qualityInsights', cells: [F, P, N, F, N, F, F, F, N] },
    ],
  },
  {
    id: 'workouts',
    ...
    rows: [
      ...
      { id: 'setsRepsWeights', cells: [F, P, N, N, F, F, N, N, F] },
      { id: 'rpeRir', cells: [F, N, N, N, F, P, N, N, F] },
      { id: 'supersets', cells: [F, N, N, N, F, P, N, N, F] },
      { id: 'prDetection', cells: [F, N, N, N, F, P, N, N, F] },
      { id: 'restTimers', cells: [F, N, N, N, F, F, N, N, F] },
      { id: 'customExercises', cells: [F, N, N, N, F, F, N, N, F] },
      { id: 'templates', cells: [F, P, N, N, F, F, N, N, F] },
      { id: 'aiPlans', cells: [F, N, N, N, F, F, N, N, N] },
      { id: 'pasteParse', cells: [F, N, N, N, N, [P, 'aiCoach'], N, N, N] },
      { id: 'editHistorical', cells: [F, P, P, N, F, P, P, P, F] },
      { id: 'exerciseGoals', cells: [F, N, N, N, F, P, N, N, P] },
      { id: 'sharing', cells: [F, P, P, N, P, P, N, N, F] },
      {
      ...
      { id: 'offlineRecovery', cells: [F, P, N, N, P, P, N, N, P] },
    ],
  },
  {
    id: 'wholeHealth',
    ...
    rows: [
      ...
      { id: 'correlationCharts', cells: [F, N, N, P, P, F, [F, 'gold'], P, P] },
      { id: 'menstrualCycle', cells: [F, N, N, [P, 'periodLogging'], N, F, N, N, N] },
      { id: 'phaseAware', cells: [F, N, N, N, N, F, N, N, N] },
      { id: 'moodRecovery', cells: [F, N, N, N, N, F, [P, 'biometrics'], P, N] },
      { id: 'sleepReadiness', cells: [P, N, N, N, N, [F, 'bestHere'], N, N, N] },
      { id: 'healthConnect', cells: [F, F, F, F, P, N, F, F, F] },
      { id: 'healthKit', cells: [F, F, F, F, P, F, F, F, F] },
      { id: 'historicalImport', cells: [F, P, P, F, P, F, F, P, P] },
      {
        id: 'bleManagement',
        cells: [
          F,
      ...
      { id: 'imuRepCounting', cells: [F, N, N, N, N, N, N, N, N] },
      {
        id: 'aiCoachConfig',
        cells: [
          F,
      ...
      { id: 'aiContext', cells: [F, P, N, N, N, F, P, P, N] },
      { id: 'customPrompts', cells: [F, N, N, N, N, [P, 'personalitiesFiles'], N, N, N] },
      { id: 'byoApiKey', cells: [F, N, N, N, N, N, N, N, N] },
      { id: 'localModels', cells: [F, N, N, N, N, N, N, N, N] },
      { id: 'gameboy', emoji: '😎', cells: [F, N, N, N, N, N, N, N, N] },
    ],
  },
];
