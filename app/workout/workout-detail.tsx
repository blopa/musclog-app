...
// Mock data - replace with actual data from props/route params
  ...
  return (
    <View className="flex-1 bg-bg-primary">
      ...
      <View
        ...
        style={{
          paddingTop: insets.top + theme.spacing.padding.xl,
      ...
      >
        <View className="flex-row items-center justify-between">
          <View className="flex-row items-center gap-1">
            <Pressable
              className="h-10 w-10 -ml-2 items-center justify-center rounded-full"
              onPress={() => router.back()}
            >
              <ArrowLeft size={theme.iconSize.lg} color={theme.colors.status.indigo600} />
            </Pressable>
            <View>
              <Text className="text-xl font-bold tracking-tight text-text-primary">{workout.name}</Text>
          ...
          <View className="flex-col gap-4">
            ...
            {workout.exercises.map((exercise) => (
              <GenericCard key={exercise.id} variant="card">
                ...
                {/* Sets Table */}
                <View className="mt-0 overflow-hidden" style={{ paddingHorizontal: theme.spacing.padding.base, paddingBottom: theme.spacing.padding.base }}>
                  {/* Table Header */}
                  <View
