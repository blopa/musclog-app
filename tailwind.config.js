    ...
    extend: {
      colors: {
        ...
        bg: {
          ...
          cardDark: theme.colors.background.cardDark,
          navBar: theme.colors.background.navBar,
          navActive: theme.colors.background.navActive,
          screen: theme.colors.background.screen,
