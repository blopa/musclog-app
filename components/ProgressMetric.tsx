  ...
  return (
    <View className="flex-1">
      <View className="mb-2 flex-row items-baseline gap-1">
        ...
        <Text className="text-sm uppercase" style={{ color: theme.colors.overlay.ink70 }}>
          {unit}
        </Text>
      </View>
      <View className="mb-2">
        <View
          ...
          style={{ backgroundColor: theme.colors.overlay.ink30 }}
        >
          <View className="h-full rounded-full bg-text-primary" style={{ width: `${progress}%` }} />
        </View>
      </View>
      <Text className="text-sm" style={{ color: theme.colors.overlay.ink70 }}>
        {bottomText}
      </Text>
    </View>
  );
